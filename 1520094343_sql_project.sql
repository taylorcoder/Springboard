...
JOIN country_club.Facilities facilities
ON bookings.facid = facilities.facid
WHERE bookings.starttime BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 23:59:99'
	AND 
		CASE WHEN bookings.memid = 0 THEN (facilities.guestcost * bookings.slots)
...
(SELECT bookings.starttime AS start_time,
	   facilities.name AS facility_name,
	   CONCAT(members.firstname, ' ', members.surname) AS member_name,
	   CASE WHEN bookings.memid = 0 THEN (facilities.guestcost * bookings.slots)
       ELSE (facilities.membercost * bookings.slots) END AS booking_cost
...
ON bookings.memid = members.memid
JOIN country_club.Facilities facilities
ON bookings.facid = facilities.facid) tmp

WHERE tmp.start_time BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 23:59:99'
	AND tmp.booking_cost>30
ORDER BY 4 DESC
